...
void urutkanproduk(produk produkList[], int jumlahProduk) {
    if (jumlahProduk == 0) {
    ...
    if (pilihan == 1) {
        for (int i = 0; i < jumlahProduk - 1; i++) {
            for (int j = 0; j < jumlahProduk - i - 1; j++) {
                if (produkList[j].namabaju > produkList[j+1].namabaju) {
                    temp = produkList[j];
        ...
        lihatproduk(produkList, jumlahProduk);
        cout << "Produk berhasil diurutkan!" << endl;
    } else if (pilihan == 2) {
        for (int i = 0; i < jumlahProduk - 1; i++) {
            for (int j = 0; j < jumlahProduk - i - 1; j++) {
                if (produkList[j].hargabaju > produkList[j+1].hargabaju) {
                    temp = produkList[j];
                    produkList[j] = produkList[j+1];
                    produkList[j+1] = temp;
                }
        ...
        for (int i = 0; i < jumlahProduk - 1; i++) {
            for (int j = 0; j < jumlahProduk - i - 1; j++) {
                if (produkList[j].stokbaju > produkList[j+1].stokbaju) {
                    temp = produkList[j];
                    produkList[j] = produkList[j+1];
                    produkList[j+1] = temp;
                }
